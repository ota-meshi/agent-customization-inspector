...
- [ ] **Root-cause design**: The plan addresses the underlying requirement with the
      simplest coherent design and contains no ad hoc workaround, silenced failure, or
      speculative abstraction.
- [ ] **Readable implementation**: Module boundaries, naming, responsibilities, and the
      non-obvious decisions or invariants that require rationale comments are identified.
- [ ] **Complete verification**: The test strategy covers appropriate unit, integration,
...
Any unmet gate MUST be resolved before Phase 0. Complexity Tracking can explain necessary
design cost, but it cannot waive a constitutional principle.
