...
**Tests**: Tests are REQUIRED. Generate the appropriate unit, integration, contract,
...
- [ ] T003 [P] Configure formatting, linting, and type checking tools
- [ ] T004 [P] Configure the test harness, coverage reporting, and CI quality gates
...
- [ ] T009 Configure error handling with session diagnostics and ordinary error reporting
...
> **NOTE: Write these tests FIRST and, when technically feasible, confirm they fail for
> the intended reason before implementation.**

- [ ] T011 [P] [US1] Unit tests for [component behavior] in tests/unit/test_[name].py
- [ ] T012 [P] [US1] Contract tests for [endpoint] in tests/contract/test_[name].py
- [ ] T013 [P] [US1] Integration tests for [user journey and failure paths] in tests/integration/test_[name].py
...
- [ ] T019 [US1] Add actionable error and diagnostic reporting for user story 1 operations
...
- [ ] T020 [P] [US2] Unit tests for [component behavior] in tests/unit/test_[name].py
- [ ] T021 [P] [US2] Contract tests for [endpoint] in tests/contract/test_[name].py
- [ ] T022 [P] [US2] Integration tests for [user journey and failure paths] in tests/integration/test_[name].py
...
- [ ] T027 [P] [US3] Unit tests for [component behavior] in tests/unit/test_[name].py
- [ ] T028 [P] [US3] Contract tests for [endpoint] in tests/contract/test_[name].py
- [ ] T029 [P] [US3] Integration tests for [user journey and failure paths] in tests/integration/test_[name].py
...
- [ ] TXXX [P] Update affected English and Japanese documentation counterparts in docs/
...
- [ ] TXXX Review trust boundaries, product-issued mutation semantics, intentional sensitive-content access, ordinary failure reporting, environment-owned resource behavior, late-work cleanup, and safe failure behavior
...
- Tests MUST be written before implementation and, when technically feasible, MUST fail
  for the intended reason before the corresponding implementation
...
Task: "Unit tests for [component behavior] in tests/unit/test_[name].py"
Task: "Contract tests for [endpoint] in tests/contract/test_[name].py"
Task: "Integration tests for [user journey and failure paths] in tests/integration/test_[name].py"
...
- Safety-sensitive tasks avoid product-defined numeric resource validation limits and
  test environment/runtime failure handling, product-issued mutation semantics,
