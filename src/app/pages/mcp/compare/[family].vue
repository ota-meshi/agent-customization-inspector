...
// `/mcp/compare?name=<declared name>&leftSource=<selector>&left=<path>&rightSource=<selector>&right=<path>`
 ...
 * home's carrier beside the repository's is the pair this route now
