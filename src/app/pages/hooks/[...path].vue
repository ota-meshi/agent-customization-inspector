 ...
 */
const carrierRoute = computed(() => detailRoute('hook', openPath.value));
...
function compareRouteForEvent(event: string): ReturnType<typeof hookComparisonRouteFor> | null {
  ...
  return counterpart === null ? null : hookComparisonRouteFor(event, openPath.value, counterpart);
}
...
const requestOpen = (): void => {
  void pageOwnership.openHookCarrierDetail(openPath.value);
};
