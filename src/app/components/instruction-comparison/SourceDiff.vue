...
<template>
  ...
  <div v-show="!mountError" class="aci-instruction-source-diff__scroller" tabindex="0">
    <div ref="host" class="aci-instruction-source-diff" />
  </div>
...
.aci-instruction-source-diff__scroller {
  overflow-x: auto;
}
