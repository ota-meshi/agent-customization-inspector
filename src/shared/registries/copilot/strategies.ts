  ...
  evidence: SHIPS_MAINTENANCE_DATA
    ? [
        ...
        },
        {
          ...
          officialHost: 'code.visualstudio.com',
          sections: ['Chat settings', 'Custom instructions settings'],
          reviewedOn: '2026-09-24',
          establishes:
            'Enablement settings decide which instruction inputs participate at all — chat.useAgentsMdFile, chat.useClaudeMdFile, chat.includeApplyingInstructions, github.copilot.chat.codeGeneration.useInstructionFiles, and for the Local agent alone the deprecated chat.instructionsFilesLocations — which is the filtering step ahead of combining them, and the setting for nested AGENTS.md files is marked experimental.',
        },
      ]
    : [],
  ...
  evidence: SHIPS_MAINTENANCE_DATA
    ? [
        ...
        },
        {
          ...
          reviewedOn: '2026-09-24',
          establishes:
            'Which skill locations participate is setting-filtered before any selection happens: chat.useAgentSkills switches skills on, and chat.agentSkillsLocations, deprecated and configuring the Local agent alone, lists that agent’s locations.',
        },
        {
  ...
  evidence: SHIPS_MAINTENANCE_DATA
    ? [
        ...
        },
        {
          ...
          reviewedOn: '2026-09-24',
          establishes:
            'Which locations contribute custom agents is configuration — chat.agentFilesLocations, deprecated and configuring the Local agent alone, and github.copilot.chat.cli.customAgents.enabled for Copilot sessions — so enablement and any configured location stay runtime conditions of this selection.',
        },
      ]
    : [],
} as const satisfies RuntimeCompositionStrategy;
