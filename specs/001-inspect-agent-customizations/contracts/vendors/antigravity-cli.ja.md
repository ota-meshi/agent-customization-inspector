...
| `antigravity.global.skill` | `conflict` | `[]` | `antigravity.behavior.user.skills` と同じ |
...
| `antigravity.behavior.user.agents` | global の custom agent | `<user tier>/config/agents/` | `antigravity.agents.selection` | `antigravity.global.agent` が accept | `google.antigravity.cli-subagents` |
| `antigravity.behavior.user.skills` | global の共有 skill | `<user tier>/antigravity-cli/skills/`、`<user tier>/config/skills/` | `antigravity.skills.selection` | `antigravity.global.skill` が accept | `google.antigravity.cli-plugins-skills`、`google.antigravity.cli-migration`、`google.antigravity.skills` |
...
| `antigravity.global.agent` | 同じ boundary | `['config', 'agents', /\.md$/u]` | `direct-child` | `static-candidate` | `antigravity.behavior.user.agents` | Documented | global の custom agent | `google.antigravity.cli-subagents` |
| `antigravity.global.skill` | 同じ boundary | `['antigravity-cli', 'skills', ANY_NAME, 'SKILL.md']`、`['config', 'skills', ANY_NAME, 'SKILL.md']`、`['antigravity-cli', 'skills', /\.md$/u]` | ディレクトリ形の2つは `exact`、フラット形は `direct-child`。行の単位はその program が名指すディレクトリまたはファイル | `static-candidate` | `antigravity.behavior.user.skills` | Conflict | 文書化された両方の root にある global の共有 skill | `google.antigravity.cli-plugins-skills`、`google.antigravity.skills` |
