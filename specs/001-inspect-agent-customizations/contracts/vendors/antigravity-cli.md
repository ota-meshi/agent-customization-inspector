...
| `antigravity.global.skill` | `conflict` | `[]` | As `antigravity.behavior.user.skills` |
...
| `antigravity.behavior.user.agents` | Global custom agents | `<user tier>/config/agents/` | `antigravity.agents.selection` | Accepted by `antigravity.global.agent` | `google.antigravity.cli-subagents` |
| `antigravity.behavior.user.skills` | Global shared skills | `<user tier>/antigravity-cli/skills/`, `<user tier>/config/skills/` | `antigravity.skills.selection` | Accepted by `antigravity.global.skill` | `google.antigravity.cli-plugins-skills`, `google.antigravity.cli-migration`, `google.antigravity.skills` |
...
| `antigravity.global.agent` | The same boundary | `['config', 'agents', /\.md$/u]` | `direct-child` | `static-candidate` | `antigravity.behavior.user.agents` | Documented | The global custom agents | `google.antigravity.cli-subagents` |
| `antigravity.global.skill` | The same boundary | `['antigravity-cli', 'skills', ANY_NAME, 'SKILL.md']`, `['config', 'skills', ANY_NAME, 'SKILL.md']`, `['antigravity-cli', 'skills', /\.md$/u]` | `exact` for the two directory programs, `direct-child` for the flat one; the row's unit is the directory or the file the program names | `static-candidate` | `antigravity.behavior.user.skills` | Conflict | The global shared skills at both documented roots | `google.antigravity.cli-plugins-skills`, `google.antigravity.skills` |
